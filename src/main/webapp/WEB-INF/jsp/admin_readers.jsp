...
<div style="padding: 70px 550px 10px">
    <form method="post" action="queryReader.html" class="form-inline"  id="searchform">
        <div class="input-group">
            <input type="text" placeholder="输入学号或姓名" class="form-control" id="search" name="searchWord" class="form-control">
