...
public class LendController {
    ...
    public ModelAndView searchReaders(String type, String searchWord) {
        ArrayList<Lend> lends = lendService.searchLend(type,searchWord);

        if(lends==null||lends.size()==0){
            return new ModelAndView("admin_lend_list", "error", "没有匹配的借阅记录 ");
        }
